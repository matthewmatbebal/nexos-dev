...
function createChart(data1, data2, labels){
    ...
    if (screenWidth < 1024) { // Если ширина экрана меньше 768px (например, это мобильное устройство)
            ...
            scales: {
                x: {
                  ...
                  ticks: {
                    ...
                    minRotation: 45, // Минимальный угол поворота меток
                    stepSize: 5,  // Шаг между метками (пример: каждая вторая метка
                    min: 0,
                    max: 5,
                  },
                },
